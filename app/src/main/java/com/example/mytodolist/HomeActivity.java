...
public class HomeActivity extends AppCompatActivity {
    ...
    private void addTask()
    {
        ...
        AppCompatButton save = myView.findViewById(R.id.btnSave);
        AppCompatButton cancel = myView.findViewById(R.id.btnCancel);
    ...
    private void updateTask()
    {
        ...
        final EditText mTask = view.findViewById(R.id.mETTask);
        final EditText mDesc = view.findViewById(R.id.mETDesc);
        ...
        AppCompatButton update = view.findViewById(R.id.btnUpdate);
        AppCompatButton delete = view.findViewById(R.id.btnDelete);
            ...
            public void onClick(View v) {
                reference.child(key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            String error = task.getException().toString();
                            Toast.makeText(HomeActivity.this, "Task deletion failed: " + error, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                dialog.dismiss();
